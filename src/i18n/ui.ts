...
const en = {
  ...
  ctaTitle: 'Learn a bit of Dutch every day',
  ctaText: 'Get one free exercise in your inbox daily.',
  ctaEmailPlaceholder: 'your@email.com',
  ctaSubscribe: 'Subscribe',
  ctaClose: 'Close',
  ctaSuccess: 'Almost done — check your inbox to confirm your subscription.',
  ctaInvalidEmail: 'Please enter a valid email address.',
  ctaRateLimited: 'Too many attempts. Please try again later.',
  ctaError: "Couldn't subscribe right now. Please try again later.",
  // Newsletter confirmation
  confirmTitle: 'Confirm subscription',
  confirmWorking: 'Confirming…',
  confirmDone: "You're confirmed! You'll get the daily exercise email from tomorrow.",
  confirmNotFound: 'This confirmation link is invalid or has expired.',
  confirmError: 'Something went wrong. Please try again later.',
  // Page titles
...
const es: UIStrings = {
  ...
  ctaTitle: 'Aprende un poco de neerlandés cada día',
  ctaText: 'Recibe un ejercicio gratis en tu correo cada día.',
  ctaEmailPlaceholder: 'tu@correo.com',
  ctaSubscribe: 'Suscribirme',
  ctaClose: 'Cerrar',
  ctaSuccess: 'Casi listo — revisa tu correo para confirmar la suscripción.',
  ctaInvalidEmail: 'Introduce un correo electrónico válido.',
  ctaRateLimited: 'Demasiados intentos. Inténtalo más tarde.',
  ctaError: 'No se pudo suscribir ahora. Inténtalo más tarde.',
  confirmTitle: 'Confirmar suscripción',
  confirmWorking: 'Confirmando…',
  confirmDone: '¡Confirmado! Recibirás el ejercicio diario a partir de mañana.',
  confirmNotFound: 'Este enlace de confirmación no es válido o ha expirado.',
  confirmError: 'Algo salió mal. Inténtalo de nuevo más tarde.',
