...
export type ExerciseType = 'verb' | 'separable' | 'positional' | 'directional' | 'from-to' | 'article' | 'plural' | 'word-order' | 'voorstellen' | 'negation' | 'preposition' | 'time-prep' | 'expression';
