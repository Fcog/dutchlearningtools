...
function ReflexiveVerbExercise({ 
  currentExercise, 
  showResult, 
  isCorrect, 
  userAnswer,
  ...
  if (!showResult) {
    return (
      <WordCard>
        ...
        {/* Show verb and context */}
        <div className="exercise-metadata">
          <div className="verb-context">
            <strong>Reflexive verb:</strong> {currentExercise.verb}
          </div>
          <div className="pronoun-context">
            <strong>Context:</strong> {currentExercise.context.replace(/_/g, ' ')}
          </div>
          <Badge 
            text={`Position: ${currentExercise.correct_position}`} 
            className="exercise-type-badge position-badge"
          />
        </div>

        {/* Input for reflexive pronoun */}
        <div className="exercise-input-container">
          <Input
            id="reflexive-pronoun-input"
            type="text"
            value={userAnswer}
            onChange={onAnswerChange}
            onKeyPress={onKeyPress}
            placeholder="Type the reflexive pronoun (e.g., me, je, zich, ons)..."
            className="reflexive-pronoun-input"
            autoFocus
          />
        </div>
...
export default ReflexiveVerbExercise
