...
export default function DirectionalAdverbsPage() {
  ...
  const [index, setIndex] = useRandomStartIndex(directionalExercises.length);
  ...
  const next = useCallback(() => {
    setIndex((i) => randomIndex(i, directionalExercises.length));
    setPhase('active');
    setSelected(null);
  }, [directionalExercises.length, setIndex]);
